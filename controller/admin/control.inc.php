<?php
namespace SchemaCatalog\Controller\Admin;
...
class Control extends \RS\Controller\Admin\Crud
{
    function __construct()
    {
        ...
        parent::__construct(new \SchemaCatalog\Model\ModelApi());
    }
    
    function helperIndex()
    {
        $helper = parent::helperIndex(); //Получим helper по-умолчанию
        $helper->setTopTitle('Админ. часть модуля SchemaCatalog'); //Установим заголовок раздела
