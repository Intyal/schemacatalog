...
*/
namespace SchemaCatalog\Controller\Block;
use \RS\Orm\Type;
...
class Category extends \RS\Controller\StandartBlock
{
    protected static
        ...
        $controller_description = 'Отображает список категорий с картинками, и если установлено, ссылается на категорию как схему';
